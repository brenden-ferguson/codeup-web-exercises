...
//         return 'Orange is the color of traffic cones.';
//     } else if(color.toLowerCase() === 'green'){
//         return 'Green is the color of grass.'
//     } else {
//         return 'I do not know anything about ' + color.toLowerCase() + '.';
//     }
//}
...
function calculateTotal(){
    if(luckyNumber === 0){
        return 'Your groceries are still $' + groceryCost
    } else if(luckyNumber === 1){
        let discount = .1
        return('Your groceries were $' + groceryCost + ' and now cost $' + (groceryCost - (groceryCost * discount)));
...
function chooseNumber(){
    ...
    if(enterNumber === true) {
        ...
        if (isNaN(parseInt(userNumber))) {
            alert('That was not a number. Please enter a number.')
        } else {
            if (userNumber % 2 === 0) {
            ...
            alert(userNumber + ' + 100 = ' + (parseInt(userNumber) + 100));
